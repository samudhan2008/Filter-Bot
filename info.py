...
CLONE_DATABASE_URI = environ.get('CLONE_DATABASE_URI', "mongodb+srv://samudhan2008:Amudhan#2008@sc1.2spuxej.mongodb.net/?retryWrites=true&w=majority&appName=SC1") # Necessary If clone mode is true
...
SHORTLINK_API = environ.get('SHORTLINK_API', 'fcf0ca1958a408acd6f0a70a58e7e29536c8b7fe')
...
if 'DYNO' in environ:
    ...
    ON_HEROKU = False
URL = environ.get("URL", "https://brief-lemming-sc-leech1-ba09b501.koyeb.app/")
